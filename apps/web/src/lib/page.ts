...
> = {
  Intro: {
    ...
    add: 'Legg til tekst eller bilder som introduserer besøkende til hva man kan få svar på ved å gjennomføre denne veiviseren.',
  },
  Page: {
    title: 'Side',
    icon: 'File',
  ...
  Result: {
    ...
    add: 'Legg til tekst eller bilder som forklarer hva brukernes svar i veiviseren betyr, slik at de får en tydelig forståelse av resultatet.',
  },
}
